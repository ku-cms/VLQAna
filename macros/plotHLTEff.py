...
def plotHLTEff () :
  ...
  c0 = ROOT.TCanvas("SingleMuon_"+run+"_"+sys.argv[2]+"_all_pass","",800,600)
  c0.cd()
  c0.SetLogy()
  hden.SetLineColor(2)
  hnum.SetLineColor(3)
  ...
  leg.AddEntry(hden,"HLT_Mu50","l")
  leg.AddEntry(hnum,"HLT_Mu50 OR combination","l")
  leg.Draw()
  c0.Update()
  ...
  c = ROOT.TCanvas("SingleMuon_"+run+"_"+"trigeff_"+sys.argv[2],"",800,600)
  c.cd()
