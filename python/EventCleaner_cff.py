...
evtcleaner = cms.EDFilter("EventCleaner",
    ...
    File_PUDistData            = cms.string('RunII2016Rereco_25ns_PUXsec69000nb.root'),
    File_PUDistDataLow         = cms.string('RunII2016Rereco_25ns_PUXsec65550nb.root'),
    File_PUDistDataHigh        = cms.string('RunII2016Rereco_25ns_PUXsec72450nb.root'),
    File_PUDistMC              = cms.string('PUDistMC_Summer2016_25ns_Moriond17MC_PoissonOOTPU.root'),
