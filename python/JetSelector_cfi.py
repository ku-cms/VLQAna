...
defaultAK4JetSelectionParameters = cms.PSet(
    ...
    jecUncPayloadNames = cms.vstring("/afs/cern.ch/work/d/devdatta/CMSREL/Analysis/CMSSW_7_4_16_patch2/src/Analysis/VLQAna/test/Summer15_25nsV6_MC/Summer15_25nsV6_MC_Uncertainty_AK4PFchs.txt"), 
...
defaultAK8JetSelectionParameters = defaultAK4JetSelectionParameters.clone( 
    ...
    scaleJetP4          = cms.bool(False),
    scaledJetMass       = cms.double(125.0), 
    jecUncPayloadNames  = cms.vstring("/afs/cern.ch/work/d/devdatta/CMSREL/Analysis/CMSSW_7_4_16_patch2/src/Analysis/VLQAna/test/Summer15_25nsV6_MC/Summer15_25nsV6_MC_Uncertainty_AK8PFchs.txt"),#'Summer15_25nsV6_MC_L2L3Residual_AK8PFchs.txt', 'Summer15_25nsV6_MC_L3Absolute_AK8PFchs.txt') , 
    jecShift            = cms.double(0), 
    jerShift            = cms.int32(0), 
