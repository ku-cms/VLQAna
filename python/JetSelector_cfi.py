...
defaultAK4JetSelectionParameters = cms.PSet(
    ...
    newJECPayloadNames        = cms.vstring("Summer15_25nsV7_MC_L1FastJet_AK4PFchs.txt","Summer15_25nsV7_MC_L2Relative_AK4PFchs.txt","Summer15_25nsV7_MC_L3Absolute_AK4PFchs.txt"), 
...
defaultAK8JetSelectionParameters = defaultAK4JetSelectionParameters.clone( 
    ...
    scaleJetP4                = cms.bool(False),
    scaledJetMass             = cms.double(125.0), 
    newJECPayloadNames        = cms.vstring("Summer15_25nsV7_MC_L1FastJet_AK8PFchs.txt", "Summer15_25nsV7_MC_L2Relative_AK8PFchs.txt", "Summer15_25nsV7_MC_L3Absolute_AK8PFchs.txt"), 
    jecUncPayloadName         = cms.string("Summer15_25nsV7_MC_Uncertainty_AK8PFchs.txt"),
    jecAK8GroomedPayloadNames = cms.vstring("Summer15_25nsV7_MC_L2Relative_AK8PFchs.txt", "Summer15_25nsV7_MC_L3Absolute_AK8PFchs.txt"), 
    jecShift                  = cms.double(0), 
    jerShift                  = cms.int32(1), 
