...
namespace hh4b{
  ...
  class DiJetInfoBranches{
    public: 
      ...
      double energy_leading2hjets_;
      int    nsubjetsBTaggedCSVL_; 
      int    doublebcategory_;

      void RegisterTree(TTree* tree, std::string name="LeadingDiJets") {
        ...
        tree->Branch((name+"_energy_leading2hjets").c_str(), &energy_leading2hjets_, (name+"_energy_leading2hjets/D").c_str()) ; 
        tree->Branch((name+"_nsubjetsBTaggedCSVL").c_str(), &nsubjetsBTaggedCSVL_, (name+"_nsubjetsBTaggedCSVL/I").c_str()) ; 
        tree->Branch((name+"_doublebcategory").c_str(), &doublebcategory_, (name+"_doublebcategory/I").c_str()) ; 
      }
      ...
      void ReadTree(TTree* tree, std::string name="SelectedEvents") {
        ...
        tree->SetBranchAddress((name+"_energy_leading2hjets").c_str(), &energy_leading2hjets_) ; 
        tree->SetBranchAddress((name+"_nsubjetsBTaggedCSVL").c_str(), &nsubjetsBTaggedCSVL_) ; 
        tree->SetBranchAddress((name+"_doublebcategory").c_str(), &doublebcategory_) ; 
      }
  ...
  class JetInfoBranches {
    public: 
      ...
      double phiSubjet0[MAX_JETS]; 
      double phiSubjet1[MAX_JETS]; 
      double energySubjet0[MAX_JETS]; 
      double energySubjet1[MAX_JETS]; 
      double doublesv[MAX_JETS]; 
      ...
      void RegisterTree(TTree *tree, std::string name="JetInfo") {
        ...
        tree->Branch((name+"_Energy").c_str(), &Energy[0] , (name+".Energy["+name+"_njets]/D").c_str()); 
        ...
        tree->Branch((name+"_phiSubjet0").c_str(), &phiSubjet0[0], (name+".phiSubjet0["+name+"_njets]/D").c_str() );
        tree->Branch((name+"_phiSubjet1").c_str(), &phiSubjet1[0], (name+".phiSubjet1["+name+"_njets]/D").c_str() );
        tree->Branch((name+"_energySubjet0").c_str(), &energySubjet0[0], (name+".energySubjet0["+name+"_njets]/D").c_str() );
        tree->Branch((name+"_energySubjet1").c_str(), &energySubjet1[0], (name+".energySubjet1["+name+"_njets]/D").c_str() );
        tree->Branch((name+"_doublesv").c_str(), &doublesv[0], (name+".doublesv["+name+"_njets]/D").c_str() );
      ...
      void ReadTree(TTree* tree, std::string name="JetInfo") {
        ...
        tree->SetBranchAddress((name+"_Energy").c_str(), &Energy[0]); 
        ...
        tree->SetBranchAddress((name+"_phiSubjet0").c_str(), &phiSubjet0[0]) ; 
        tree->SetBranchAddress((name+"_phiSubjet1").c_str(), &phiSubjet1[0]) ; 
        tree->SetBranchAddress((name+"_energySubjet0").c_str(), &energySubjet0[0]) ; 
        tree->SetBranchAddress((name+"_energySubjet1").c_str(), &energySubjet1[0]) ; 
        tree->SetBranchAddress((name+"_doublesv").c_str(), &doublesv[0]) ; 
