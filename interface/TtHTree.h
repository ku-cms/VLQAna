...
class TtHEventInfoBranches {
  public:
    ...
    double mtprimeDummyLoose_;
    double mtprimeDummyLooseBTag_;
    double ht_ ; 
    int    nAK4_;
    int    nAK8_;
    bool   isRegionA_;
    bool   isRegionB_;
    bool   isRegionBLoose_;
    bool   isRegionBLooseBTag_;
    bool   isRegionC_;
    bool   isRegionD_;
    ...
    void RegisterTree(TTree* cutTree, std::string name="SelectedEvents") {
      ...
      cutTree->Branch("mtprimeDummyLoose",&mtprimeDummyLoose_, "mtprimeDummyLoose/D");
      cutTree->Branch("mtprimeDummyLooseBTag",&mtprimeDummyLooseBTag_, "mtprimeDummyLooseBTag/D");
      ...
      cutTree->Branch("isRegionBLoose",&isRegionBLoose_, "isRegionBLoose/O");
      cutTree->Branch("isRegionBLooseBTag",&isRegionBLooseBTag_, "isRegionBLooseBTag/O");
